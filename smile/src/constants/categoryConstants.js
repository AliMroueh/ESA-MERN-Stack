    ...
    export const GET_ONE_CATEGORIES_REQUEST = "GET_ONE_CATEGORIES_REQUEST";
    export const GET_ONE_CATEGORIES_SUCCESS = "GET_ONE_CATEGORIES_SUCCESS";
    export const GET_ONE_CATEGORIES_FAILURE = "GET_ONE_CATEGORIES_FAILURE";
